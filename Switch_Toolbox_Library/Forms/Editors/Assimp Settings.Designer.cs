namespace Toolbox.Library.Forms
{
    partial class Assimp_Settings
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.generateNormalsChk.Text = "生成法线（如果未使用）";
            ...
            this.joinDupedVertsSk.Text = "连接重复顶点";
